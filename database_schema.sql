...
CREATE DATABASE DefectTest
ON PRIMARY (
    NAME = N''DefectTest_Data'',
    FILENAME = N''' + @DataPath + 'DefectTest.mdf''
)
LOG ON (
    NAME = N''DefectTest_Log'',
    FILENAME = N''' + @LogPath + 'DefectTest.ldf''
);';
...
begin
EXEC [DefectTest].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO

ALTER DATABASE [DefectTest] SET ANSI_NULL_DEFAULT OFF 
GO

ALTER DATABASE [DefectTest] SET ANSI_NULLS OFF 
GO

ALTER DATABASE [DefectTest] SET ANSI_PADDING OFF 
GO

ALTER DATABASE [DefectTest] SET ANSI_WARNINGS OFF 
GO

ALTER DATABASE [DefectTest] SET ARITHABORT OFF 
GO

ALTER DATABASE [DefectTest] SET AUTO_CLOSE OFF 
GO

ALTER DATABASE [DefectTest] SET AUTO_SHRINK OFF 
GO

ALTER DATABASE [DefectTest] SET AUTO_UPDATE_STATISTICS ON 
GO

ALTER DATABASE [DefectTest] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO

ALTER DATABASE [DefectTest] SET CURSOR_DEFAULT  GLOBAL 
GO

ALTER DATABASE [DefectTest] SET CONCAT_NULL_YIELDS_NULL OFF 
GO

ALTER DATABASE [DefectTest] SET NUMERIC_ROUNDABORT OFF 
GO

ALTER DATABASE [DefectTest] SET QUOTED_IDENTIFIER OFF 
GO

ALTER DATABASE [DefectTest] SET RECURSIVE_TRIGGERS OFF 
GO

ALTER DATABASE [DefectTest] SET  DISABLE_BROKER 
GO

ALTER DATABASE [DefectTest] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO

ALTER DATABASE [DefectTest] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO

ALTER DATABASE [DefectTest] SET TRUSTWORTHY OFF 
GO

ALTER DATABASE [DefectTest] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO

ALTER DATABASE [DefectTest] SET PARAMETERIZATION SIMPLE 
GO

ALTER DATABASE [DefectTest] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [DefectTest] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [DefectTest] SET RECOVERY FULL 
GO

ALTER DATABASE [DefectTest] SET  MULTI_USER 
GO

ALTER DATABASE [DefectTest] SET PAGE_VERIFY CHECKSUM  
GO

ALTER DATABASE [DefectTest] SET DB_CHAINING OFF 
GO

ALTER DATABASE [DefectTest] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [DefectTest] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [DefectTest] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [DefectTest] SET QUERY_STORE = OFF
GO

ALTER DATABASE [DefectTest] SET  READ_WRITE 
GO
