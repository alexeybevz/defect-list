...
{
    public class OpenReplaceNameBomItemFormCommand : CommandBase
    {
        ...
        public OpenReplaceNameBomItemFormCommand(DefectListItemViewModel bomItemViewModel, SelectedBomItemStore selectedBomItemStore, ProductsStore productsStore, BomItemsStore bomItemsStore)
        {
        ...
        public override void Execute(object parameter = null)
        {
            ...
            {
                _bomItemsStore.ReplaceName(_bomItemViewModel.BomHeader, _selectedBomItemStore.SelectedBomItem, newBomItem.Detal, _bomItemViewModel.UserIdentity.Name);
            };
